...
struct binder_ {void *key; int value; binder next; void *prevtop;};
struct TAB_table_ {
...
static binder Binder(void *key, int value, binder next, void *prevtop) {
 ...
 ********************************************************/
void TAB_enter(TAB_table t, void *key, int value) {
    int index;
    assert(t && key);
