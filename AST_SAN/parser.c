...
static const yytype_uint8 yyrline[] =
{
      ...
      86,    87,    88,    89,    93,    93,    97,    98,    98,   102,
     103,   107,   108,   109,   113,   114,   118,   119,   120,   120,
     120,   121,   122,   123,   123,   123,   127,   131,   141,   158,
     168,   178,   197,   198,   202,   202,   202,   203,   203,   203,
     207,   211,   215,   221,   222,   223,   227,   228,   229,   230,
...
#line 69 "parser.y" /* yacc.c:1646  */
    {scope++; S_beginScope(tab,scope);}
#line 1687 "parser.c" /* yacc.c:1646  */
    break;

  case 12:
#line 69 "parser.y" /* yacc.c:1646  */
    {scope--; S_endScope(tab);}
...
#line 97 "parser.y" /* yacc.c:1646  */
    {S_beginScope(p_tab, 0); scope++; S_beginScope(tab, scope); (yyval) = new_subtree(PARAM_LIST_NODE,0);}
#line 1777 "parser.c" /* yacc.c:1646  */
    break;

  case 27:
#line 98 "parser.y" /* yacc.c:1646  */
    {S_beginScope(p_tab, 0); scope++; S_beginScope(tab, scope);}
...
#line 131 "parser.y" /* yacc.c:1646  */
    {if(lookup_var(p_tab, getName((yyvsp[0])))!=-1) {
                                                        ...
                                                        if(lookup_var(tab, getName((yyvsp[0])))==-1) {
                                                            handle_error(NOT_DEFINE, getName((yyvsp[0])), yylineno);
                                                        }   
...
#line 141 "parser.y" /* yacc.c:1646  */
    {(yyval) = new_subtree(TMP_NODE, 0); 
                                                    ...
                                                    if(lookup_var(p_tab, getName((yyvsp[-3])))!=-1) {
                                                        ...
                                                        if(lookup_var(tab, getName((yyvsp[-3])))==-1) {
                                                            handle_error(NOT_DEFINE, getName((yyvsp[-3])), yylineno);
                                                        }
...
#line 168 "parser.y" /* yacc.c:1646  */
    {if(lookup_var(p_tab, getName((yyvsp[-2])))!=-1) {
                                                        ...
                                                        if(lookup_var(tab, getName((yyvsp[-2])))==-1) {
                                                            handle_error(NOT_DEFINE, getName((yyvsp[-2])), yylineno);
                                                        }                                                    
                                                        (yyval) = new_subtree(SVAR_NODE, 0); 
...
#line 215 "parser.y" /* yacc.c:1646  */
    {if(lookup_func(f_tab, getName((yyvsp[-3])))!=call_arity) {
                                                        handle_error(PARAMERROR, getName((yyvsp[-3])), yylineno);} 
...
#line 222 "parser.y" /* yacc.c:1646  */
    {call_arity=0; (yyval) = new_subtree(ARG_LIST_NODE, 1, (yyvsp[0])); call_arity++;}
#line 2062 "parser.c" /* yacc.c:1646  */
    break;

  case 65:
#line 223 "parser.y" /* yacc.c:1646  */
    {call_arity=0; (yyval) = new_subtree(ARG_LIST_NODE, 0);}
